...
jsPsych.plugins["audio-categorization"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial.key_answer = jsPsych.pluginAPI.convertKeyCharacterToKeyCode(trial.key_answer) || jsPsych.pluginAPI.convertKeyCharacterToKeyCode('f'); // key associated to the category
